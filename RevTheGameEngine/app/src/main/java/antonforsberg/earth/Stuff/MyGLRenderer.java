package anton.forsberg.earth.Stuff;
...
/*
    ...
    */
    ...
    private void drawCube()
    {
        ...
        GLES20.glUniform3f(mLightPosHandle, 0f, 0f, -2.5f);

       // Log.d("light", String.valueOf(mLightPosInEyeSpace[0])+" ---- "+String.valueOf(mLightPosInEyeSpace[1])+" ---- "+String.valueOf(mLightPosInEyeSpace[2]));
